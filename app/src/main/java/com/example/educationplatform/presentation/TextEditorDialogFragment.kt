...
class TextEditorDialogFragment: DialogFragment(R.layout.text_dialog_fragment) {
    ...
    companion object {
        fun newInstance(editableBlockBase: EditableBlockBase): TextEditorDialogFragment {
